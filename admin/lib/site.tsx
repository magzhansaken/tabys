...
export const STORE_LINKS = [
  { href: '/для-продуктового-магазина', ru: 'Продуктовый магазин', kk: 'Азық-түлік дүкені' },
  { href: '/для-магазина-разливных-напитков', ru: 'Разливные напитки', kk: 'Құйма сусындар' },
  { href: '/для-магазина-одежды', ru: 'Магазин одежды', kk: 'Киім дүкені' },
  { href: '/для-кофейни', ru: 'Кофейня при магазине', kk: 'Дүкен жанындағы кофейня' },
  { href: '/для-хозтоваров', ru: 'Хозтовары и стройка', kk: 'Шаруашылық тауарлары' },
];
...
export function SiteHeader({ lang, onLang, active }: { lang: Lang; onLang: () => void; active?: string }) {
  ...
  const items = [
    { href: '/возможности', label: n.features, key: 'features' },
    { href: '/касса', label: n.kassa, key: 'kassa' },
    { href: '/цены', label: n.prices, key: 'prices' },
    { href: '/для-продуктового-магазина', label: n.stores, key: 'stores' },
    { href: '/вопросы', label: n.faq, key: 'faq' },
  ];
        ...
        <div style={{ ...S.wrap, padding: 'clamp(36px,6vw,52px) clamp(16px,4vw,24px) 20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 32 }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gap: 9 }}>
              <a href="/возможности" style={{ color: C.prose, textDecoration: 'none', fontSize: 14 }}>{n.features}</a>
              <a href="/касса" style={{ color: C.prose, textDecoration: 'none', fontSize: 14 }}>{n.kassa}</a>
              <a href="/цены" style={{ color: C.prose, textDecoration: 'none', fontSize: 14 }}>{n.prices}</a>
              <a href="/вопросы" style={{ color: C.prose, textDecoration: 'none', fontSize: 14 }}>{n.faq}</a>
            </div>
          </div>
          <div>
      ...
      <div style={{ ...S.wrap, padding: full ? '16px clamp(16px,4vw,24px) 28px' : '24px clamp(16px,4vw,24px) 28px', borderTop: full ? `1px solid ${C.lineIn}` : 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
        ...
        {!full && (
          <div style={{ display: 'flex', gap: 18, flexWrap: 'wrap' }}>
            ...
            <a href="/возможности" style={{ color: C.dim, textDecoration: 'none', fontSize: 13.5 }}>{n.features}</a>
            <a href="/цены" style={{ color: C.dim, textDecoration: 'none', fontSize: 13.5 }}>{n.prices}</a>
