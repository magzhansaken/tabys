...
export const P = {
  ...
  // Боковое меню — тёмный графит с латунной подсветкой. Ровно их
  // цвета: меню это первое, что видно, и именно оно делает кабинет
  // узнаваемым.
  navBg:     '#191d1f',   // графит
  navInk:    '#f2efe8',   // кремовый текст
  navDim:    '#b3ada2',   // неактивный пункт
  navHover:  'rgba(255,255,255,.08)',
  navOn:     'rgba(232,163,61,.18)',   // выбранный пункт: латунь на просвет
  navOnInk:  '#e8b168',   // текст выбранного
  navLine:   '#2c3438',
  sideW:     246,         // ширина меню, как у них
