    ...
    <div className="modal"
      ...
      <div className="modal-card" ref={card}
        ...
        <div className="sheet-head">
          ...
          {/* ЗАГОЛОВОК ОДИН. Партнёр заводит магазин так же, как
              владелец платформы: доступы выходят сразу, он отдаёт их
              владельцу магазина при нём.
              Разница лишь в том, что владелец платформы потом
              подтверждает приведённого клиента — партнёру про это
              думать незачем. */}
          <h2>Новый клиент</h2>
