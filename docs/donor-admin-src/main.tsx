...
const LS_TOKEN = 'dastarhan.platform.token';
const LS_USER = 'dastarhan.platform.user';
 ...
 */
export function requestMark(r: { kind: string; payload: Record<string, unknown>;
