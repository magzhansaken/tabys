...
const RULES = [
  ...
  { file: 'pos2/renderer/screen-paid.js', must: 'ПОЛЯ СВОДИМ ПОД СВЁРТКУ',
    why: 'Экран сдачи показывал «undefined» вместо суммы: имена полей расходились' },
  ...
  { file: 'pos2/renderer/screen-menu.js', must: 'НАЙДЕНО ВАМИ',
