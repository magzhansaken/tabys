-- =====================================================================
-- 097_journal_request.sql — журнал называет итог решения по заявке.
--
-- Запись «Заявка одобрена» без итога ничего не говорит: одобрили ЧТО и
-- ПОЧЁМ? А это деньги — через полгода спросят именно об этом.
--
-- Теперь: «Заявка одобрена — Касса 2 подключена · 2 500 ₸/мес ·
-- Мини-маркет».
-- =====================================================================
